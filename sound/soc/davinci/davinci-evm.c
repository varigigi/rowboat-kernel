...
static struct snd_soc_card am335x_var_som_soc_card = {
	.name = "AM335X EVM",
	.dai_link = am335x_var_som_dai,
	.num_links =ARRAY_SIZE(am335x_var_som_dai),
};
...
static int __init evm_init(void)
{
	...
	if (machine_is_davinci_evm()) {
		...
		evm_snd_dev_data = &am335x_var_som_soc_card;
		index = 0;
	} else
		return -EINVAL;
